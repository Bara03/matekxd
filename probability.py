import sys
available_prb_types=["Szórás/eloszlás","Kiválasztás","Teljes valószínűség, bayes(egyforma ládák)"]
class basicMath:
...
def start_solve_probability_task():
    for i,v in enumerate(available_prb_types, start=1):
        print(f"[{i}] : {v}")
